...
def pesos(val, vet):
    ...
    file_pesos = f"./{nO}oxigenios/hopping-{hop}/{nO}_Pnm.txt"
    file_pesosxx = f"./{nO}oxigenios/hopping-{hop}/{nO}_Pxxnm.txt"
    file_pesosxy = f"./{nO}oxigenios/hopping-{hop}/{nO}_Pxynm.txt"
    
    file_polarizacao = f"./{nO}oxigenios/hopping-{hop}/{nO}_matriz_dipolo.txt"
    file_polarizacaoX = f"./{nO}oxigenios/hopping-{hop}/{nO}_matriz_dipolo_X.txt"
    file_polarizacaoY = f"./{nO}oxigenios/hopping-{hop}/{nO}_matriz_dipolo_Y.txt"
...
val, vet = read_autocoisas(f"./{nO}oxigenios/hopping-{hop}/{nO}_autocoisas.txt")
