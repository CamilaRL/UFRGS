...
#propriedades_plot_temp('energiaT_20.txt')
#propriedades_plot_temp('magnetizacaoT_20.txt')
#propriedades_plot_temp('susceptibilidadeT_20.txt')
#propriedades_plot_temp('calorespecificoT_20.txt')
